<template>
  ...
  <div id="app">
    <AnimatedSVG v-if="isLoading" />
    <div v-else class="max-w-7xl mx-auto flex flex-col relative">
      <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
        <div class="container mx-auto flex flex-wrap items-center justify-between">
          <button @click="redirectToHome" class="flex">
            <img src="img/favicon.png" alt="logo" class="w-12 h-9 flex fadein-bot md:order-2">
          </button>

          <div class="flex md:order-2 fadein-bot">
            <a href="https://github.com/Khemarint"><img class="w-9 rounded-full"
                src="https://seeklogo.com/images/G/github-logo-2E3852456C-seeklogo.com.png" alt="github"></a>
          </div>
...
export default {
  ...
  watch: {
    '$route': function () {
      ...
      console.log(this.isLoading);   // Delay of 4 seconds
    },
  },
  methods: {
    redirectToHome() {
