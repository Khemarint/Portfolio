<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200 fadein-up">Hello There, I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Khemarint</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right">
      <img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-7/12 md:h-auto rounded-full border-4 border-amber-200 pict  object-cover"  src="/img/Khemarint.png" >
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["IT Support", "Software developer", "Web developer", "Mobile developer", "Networking", "Cyber Security"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
